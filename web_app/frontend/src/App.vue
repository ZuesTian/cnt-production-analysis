...
<style scoped>
.login-page{display:flex;min-height:100vh;flex-direction:column;padding:32px clamp(24px,5vw,80px) 24px;overflow:hidden;color:#183330;background:linear-gradient(135deg,#f4f1e9 0%,#f7f7f2 52%,#e7f0eb 100%)}
...
.login-page__brand{position:relative;display:flex;align-items:center;gap:12px}.login-page__brand>span:last-child{display:flex;flex-direction:column}.login-page__brand strong{font-size:15px;letter-spacing:.08em}.login-page__brand small{margin-top:2px;color:#68807b;font-size:8px;letter-spacing:.18em}.login-page__mark{display:flex;width:38px;height:38px;align-items:flex-end;justify-content:center;gap:3px;padding:8px;border-radius:9px;background:#126e6b;box-shadow:0 8px 22px rgba(18,110,107,.2)}.login-page__mark i{display:block;width:4px;border-radius:2px;background:#d9eee5}.login-page__mark i:nth-child(1){height:11px}.login-page__mark i:nth-child(2){height:20px}.login-page__mark i:nth-child(3){height:15px}
.login-page__grid{position:relative;display:grid;width:min(1120px,100%);grid-template-columns:minmax(0,1.2fr) minmax(340px,440px);align-items:center;gap:clamp(48px,8vw,120px);margin:auto}.login-intro>p:first-child,.login-card__eyebrow{margin:0;color:#167875;font-size:11px;font-weight:800;letter-spacing:.2em}.login-intro h1{margin:18px 0 28px;font-family:Georgia,"Noto Serif SC",serif;font-size:clamp(38px,4.3vw,64px);font-weight:500;line-height:1.18;letter-spacing:-.035em}.login-intro__rule{width:76px;height:3px;background:#ca8a3b}.login-intro__copy{max-width:520px;margin:24px 0 34px;color:#5e716d;font-size:15px;line-height:1.9}.login-intro dl{display:grid;max-width:520px;grid-template-columns:repeat(3,1fr);margin:0}.login-intro dl div{padding:0 18px;border-left:1px solid rgba(23,75,70,.17)}.login-intro dl div:first-child{padding-left:0;border:0}.login-intro dt{font-size:14px;font-weight:800}.login-intro dd{margin:5px 0 0;color:#7a8986;font-size:11px}
.login-card{padding:42px 40px 36px;border:1px solid rgba(21,73,68,.12);border-radius:18px;background:rgba(255,255,255,.86);box-shadow:0 28px 75px rgba(39,64,58,.12);backdrop-filter:blur(18px)}.login-card h2{margin:10px 0 8px;font-size:28px;letter-spacing:-.04em}.login-card__hint{margin:0 0 30px;color:#71817e;font-size:13px}.login-card form{display:grid;gap:8px}.login-card label{margin-top:9px;color:#334a46;font-size:12px;font-weight:750}.login-card :deep(.el-input__wrapper){min-height:48px;border-radius:9px;box-shadow:0 0 0 1px #d8dfdc inset}.login-card :deep(.el-input__wrapper.is-focus){box-shadow:0 0 0 1px #167875 inset,0 0 0 3px rgba(22,120,117,.1)}.login-card .el-button{width:100%;min-height:48px;margin-top:15px;border-radius:9px}.login-card>small{display:block;margin-top:18px;color:#81908d;font-size:10px;line-height:1.6;text-align:center}.login-page footer{position:relative;color:#80908c;font-size:9px;letter-spacing:.16em}
